...
private:
    ...
    std::string input_pose_, input_pointcloud_, output_skeleton_;
    
    static const int INPUT_QUEUE_SIZE_ = 120;

    //void dummy_test(const tfpose_ros::Persons::ConstPtr &persons_msg, const PointCloud::ConstPtr &point_cloud);
