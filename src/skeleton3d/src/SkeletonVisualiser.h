...
private:
    ...
    static std::vector<std::vector<geometry_msgs::Point>> construct_point_line(const std::vector<skeleton3d::BodyPart3d> &all_body_parts, std::vector<int> adjacency_list);
